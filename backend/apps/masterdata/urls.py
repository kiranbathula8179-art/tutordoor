...
urlpatterns = [
    ...
    path("admin/items/<uuid:item_id>/activate/", views.AdminItemActivateView.as_view(), name="masterdata_admin_activate"),
    path("admin/items/<uuid:item_id>/deactivate/", views.AdminItemDeactivateView.as_view(), name="masterdata_admin_deactivate"),
