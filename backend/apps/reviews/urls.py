...
urlpatterns = [
    ...
    path("tutor-reviews/<uuid:review_id>/respond/", views.RespondToTutorReviewView.as_view(), name="respond_tutor_review"),
    ...
    path("enrollments/<uuid:enrollment_id>/submit/", views.SubmitCourseReviewView.as_view(), name="submit_course_review"),
    path("course-reviews/<uuid:review_id>/respond/", views.RespondToCourseReviewView.as_view(), name="respond_course_review"),
]
